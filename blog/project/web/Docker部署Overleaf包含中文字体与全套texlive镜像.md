...
image: /assets/images/cover/overleaf.png
sticky: 2
authors: RiverMountain
---
![](assets/Docker部署Overleaf包含中文字体与全套texlive镜像/image-20230424111833.png)
...
![](assets/Docker部署Overleaf包含中文字体与全套texlive镜像/image-20230424111857.png)

> 注意：在Overleaf实现中文输出需采用`XeLaTex`编译，在页面右上角可进行设置

![](assets/Docker部署Overleaf包含中文字体与全套texlive镜像/image-20230424111912.png)
