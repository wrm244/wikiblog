...
* ApplicationContext要想成为延迟加载，只需要按照如下方式进行配置
  ...
  <beans xmlns="http://www.springframework.org/schema/beans"
         ...
         xsi:schemaLocation="
              http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans.xsd">
      <bean id="bookDao" class="com.wrm244.dao.impl.BookDaoImpl"  lazy-init="true"/>
  </beans>
  ```
...
<context:component-scan base-package="org.wrm244"/>
...
* 包路径越多[如:com.wrm244.dao.impl]，扫描的范围越小速度越快
* 包路径越少[如:com.wrm244],扫描的范围越大速度越慢
* 一般扫描到项目的组织名称即Maven的groupId下[如:com.wrm244]即可。
...
```java
@Configuration
@ComponentScan("com.wrm244.config")
public class SpringConfig {
...
JdbcConfig类要放入到`com.wrm244.config`包下，需要被Spring的配置类扫描到即可
...
<configuration>
    ...
    <!--别名扫描的包路径-->
    <typeAliases>
        <package name="com.wrm244.domain"/>
    </typeAliases>
    <!--数据源-->
    ...
    <!--映射文件扫描包路径-->
    <mappers>
        <package name="com.wrm244.dao"></package>
    </mappers>
</configuration>
```
